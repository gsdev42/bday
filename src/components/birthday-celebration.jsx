...
export default function BirthdayCelebration() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        <h1 className="text-4xl sm:text-5xl font-bold text-center text-pink-600 mb-2">Happiest Birthday!</h1>
        <div className="flex justify-center gap-3">
          <Cake className="w-8 h-8 text-pink-500" />
          <Sparkles className="w-8 h-8 text-yellow-500" />
          <Heart className="w-8 h-8 text-pink-500" />
        </div>
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">to my cute medico  :)</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                I wish tu hamesha khush rahe aur hasti rahe.
                </p>
                <p className="text-pink-600 font-medium">wish u the happiest 20 years 💖</p>
                <div className="flex justify-center">
                  <motion.div
                    animate={{
                      scale: [1, 1.2, 1],
      ...
      >
        <div className="text-center">
          ...
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">Meri pyari behen🫶</p>
          </div>
        </div>
      </motion.div>
    </div>
